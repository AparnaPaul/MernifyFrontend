...
export const ProductProvider = ({ children }) => {
    ...
    async function fetchProducts() {
        try {
            const { data } = await axios.get(`https://mernifyserver.onrender.com/api/product/all?search=${search}&category=${category}&sortByPrice=${price}&page=${page}`);
    ...
    async function fetchProduct(id) {
        setLoading(true)
        try {
            const { data } = await axios.get(`https://mernifyserver.onrender.com/api/product/${id}`)
